...
async function main() {
    ...
    console.log("Created games:", games.map((g) => g.name));
    ...
    console.log("Created tournaments:", tournaments.map((t) => t.title));
